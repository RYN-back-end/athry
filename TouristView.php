...
<main>
    ...
    <section class="breadcrumb d-flex items-center justify-center relative overflow-hidden">
        ...
        <div class="container">
            <h1 class="title capitalize pb-5 text-center fs-r-36 fw-700 line-normal"> عرض المعالم السياحية <span
                        id="userName"></span></h1>
...
<!---->
                                    ...
                                    <div class="body">
                                        ...
                                        <button class="btn btn-popup booking-btn mb-2 py-5 round-6 mx-auto d-flex items-center justify-center fs-18 fw-500"
                                                type="button" aria-label="احجز الان"><a
                                                    href="detailsTouristView.php?id=<?php echo $row['landmark_id'] ?>">
                                                عرض التفاصيل </a></button>
                                    </div>
                                    <!-- end -->
                                </div>
                            </a>
