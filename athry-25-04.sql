...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2024 at 11:29 PM
...
CREATE TABLE `cart` (
  ...
  `status` enum('new','confirmed') NOT NULL DEFAULT 'new',
  `from_date` date DEFAULT NULL,
  `to_date` date DEFAULT NULL,
  `person_no` int(5) DEFAULT 0,
  `guide_id` int(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `cart` (`id`, `client_id`, `tour_id`, `price`, `status`, `from_date`, `to_date`, `person_no`, `guide_id`) VALUES
(4, 5, 6, 3804, 'confirmed', '1985-08-24', '1990-10-18', 35, 2);
...
(5, '23qwesd', 'mohamedgammal55@gmail.com', '$2y$10$Cv/pPdo8aYAO/TA8nB/QMe/D1H.uHLnV2aThnx4OdDLogxlJR.MHq', '123456', '', 1);
...
(2, 'admin@admin.com', 'mohamedgammal55@gmail.com', '$2y$10$T/9IfiFyyqrJP1UVF4QSwO7ONxKEbiKaJbxuhz62zqjRmOCvKUHq6', '212345', '', 1),
(3, 'admin@admin.com', 'mohamedgammal55@gmail.com33', '$2y$10$QJ6jMWBZvt3mX3cZsRAAPOjEcChItATCN2yRI2FMhO3PalAYUewHS', '01011827324', '', 2);
...
INSERT INTO `payments` (`pay_id`, `pay_name`, `pay_no`, `valid_date`, `cvv`, `client_id`) VALUES
(1, 'mohamed jamal', '5208 5205 2052 0205', '45-52', '123', 5),
(2, 'admin@admin.com', '1201 2051 2051 0510', '45-52', '123', 5);
...
ALTER TABLE `cart`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cart_client_id` (`client_id`),
  ADD KEY `cart_tour_id` (`tour_id`);
...
--
ALTER TABLE `guides`
  MODIFY `guide_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `cart_client_id` FOREIGN KEY (`client_id`) REFERENCES `clients` (`client_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `cart_tour_id` FOREIGN KEY (`tour_id`) REFERENCES `tours` (`tour_id`) ON DELETE CASCADE;
